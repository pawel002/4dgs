...
async function main() {
    ...
    // Vendored for offline use: load a local .splat next to the deck instead of
    // the original HuggingFace-hosted scenes. Override with ?url=... if needed.
    const url = new URL(
        params.get("url") || "../assets/gs_scene.splat",
        location.href,
    );
