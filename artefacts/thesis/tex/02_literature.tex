...
\begin{itemize}
    \item COLMAP's incremental Structure-from-Motion, used for real world applications of the 4DGS.
...
parameter $(\boldsymbol{\mu}_i, \mathbf{q}_i, \mathbf{s}_i, \tilde\sigma_i, \mathrm{SH}_i)$. Finally, two indexing conventions are used throughout the thesis: $t \in \{0,\dots,F-1\}$
