...
Gaussian Splatting baseline from a single orbiting camera and reaches a held-out
quality of over $40$\,dB, which confirms that the static half of the problem needed
no new research. The foreground is observed by four fixed, calibrated cameras and
